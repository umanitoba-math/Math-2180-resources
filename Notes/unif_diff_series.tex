...
\end{proof}
We mentioned in~\Cref{sec:intro} that, for a function series given by
\[
...
\]
Again, the exclamation point is meant to emphasise that this is not true in general! The derivative of an infinite series is not necessarily the same as the infinite series of derivatives. Nevertheless, \Cref{thm:unif_cvg_diff} gives a crucial ingredient into proving the case where this is true. To get there, we will first need to develop some preliminaries for function series.